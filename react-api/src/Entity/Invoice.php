 ...
 *          "swagger_context" = {"type" = "string", "name" = "plop", "description" = "incrémente le chrono d'une facture donnée" }
 *     }},
 *     attributes={
...
class Invoice
{
     ...
     * @Assert\Type(type="numeric", message="le montant doit etre un numérique !")
     */
    private $amount;
     ...
     * @Assert\NotBlank(message="La date doit être renseigne")
     */
    private $sentAt;
     ...
     * @Assert\Type(type="integer", message="le montant doit etre un nombre !")
     */
    private $chrono;

    /**
     * Recupere le user a qui appartient la facture
